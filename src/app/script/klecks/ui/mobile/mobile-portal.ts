...
export class MobilePortal {
    ...
    private buildWelcomeView(): void {
        ...
        helpBtn.addEventListener('click', () => {
            this.showInfoDialog('AnimePaint Mobile v1.8.7', 'تطبيق رسم احترافي للهاتف مع طبقات، معرض محلي، وأدوات تخصيص متقدمة.');
        });
        ...
        const version = BB.el({ className: 'mp-logo-version', content: 'النسخة المحمولة Ver 1.8.7' });
